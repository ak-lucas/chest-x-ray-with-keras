...
flow_1 = Conv2D(64, kernel_size=(1, 1), padding='same')(input_img)
#flow_1 = BatchNormalization()(flow_1)
flow_1 = Activation('relu')(flow_1)

flow_2 = Conv2D(64, kernel_size=(1, 1), padding='same')(input_img)
#flow_2 = BatchNormalization()(flow_1)
flow_2 = Activation('relu')(flow_1)
flow_2 = Conv2D(64, kernel_size=(3, 3), padding='same')(flow_2)
#flow_2 = BatchNormalization()(flow_1)
flow_2 = Activation('relu')(flow_2)
#flow_2 = MaxPooling2D(pool_size=(2,2))

flow_3 = Conv2D(64, kernel_size=(1, 1), padding='same')(input_img)
#flow_3 = BatchNormalization()(flow_1)
flow_3 = Activation('relu')(flow_3)
flow_3 = Conv2D(64, kernel_size=(5, 5), padding='same')(flow_3)
#flow_3 = BatchNormalization()(flow_1)
flow_3 = Activation('relu')(flow_3)
#flow_3 = MaxPooling2D(pool_size=(2,2))

flow_4 = MaxPooling2D(pool_size=(3, 3), strides=(1, 1))
flow_4 = Conv2D(64, kernel_size=(5, 5), padding='same')(flow_4)
#flow_4 = BatchNormalization()(flow_1)
flow_4 = Activation('relu')(flow_4)

concat = concatenate([flow_1, flow_2, flow_3, flow_4])
...
train_generator = datagen_aug.flow_from_directory(path+train_dir,
																									to_categorical(Y_train[train_idx]),
																									batch_size=128,
																									color_mode='rgb',
																									class_mode='categorical',
																									seed=7,
																									)
val_generator = datagen_no_aug.flow_from_directory(path+val_dir,
																									batch_size=128,
																									color_mode='rgb',
																									class_mode='categorical',
																									seed=7)
